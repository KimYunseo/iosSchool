...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        CustomTableViewCell2 *cell = [[CustomTableViewCell2 alloc] initSectionZero] ;
        ...
        CustomTableViewCell2 *cell = [[CustomTableViewCell2 alloc] initSectionOne] ;
        return cell;
    } else if (indexPath.row == 3){
        CustomTableViewCell2 *cell = [[CustomTableViewCell2 alloc] initSectionTwo] ;
        return cell;
    } else {
